  ...
  return (
    <header
      style={{
        ...
        height: 64,
        background: '#FFFFFF',
        // V45 precision: header shadow más sutil (0.06 → 0.05 final layer), divider y base preservados
        boxShadow: '0 1px 0 rgba(15,23,42,0.06), 0 2px 8px rgba(15,23,42,0.04), 0 4px 14px rgba(15,23,42,0.05)',
