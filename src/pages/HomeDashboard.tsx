...
export default function HomeDashboard() {
  ...
  const mainCards: CardConfig[] = [
    ...
    { id: 'comercial', label: 'Comercial', route: '/ventas/dashboard', bgColor: '#14306E', gradient: 'linear-gradient(145deg, #1A3D88 0%, #122A62 40%, #081840 100%)', decorType: 'silk', decorColor: 'rgba(255,255,255,0.10)', iconFile: 'comercial.svg', iconOpacity: 0.24, kpiValue: kpis.formatosActivos.toLocaleString(), kpiLabel: 'formatos', statusDot: 'green', statusText: '11 submódulos', gridColumn: '4 / 5', gridRow: '1 / 3' },
    ...
    { id: 'comunicaciones', label: 'Comunicaciones', route: '/comunicaciones/dashboard', bgColor: '#1E4EA0', gradient: 'linear-gradient(148deg, #265CC0 0%, #1A4488 40%, #0E2A58 100%)', decorType: 'silk', decorColor: 'rgba(255,255,255,0.10)', iconFile: 'comunicaciones.svg', iconOpacity: 0.24, kpiValue: '5', kpiLabel: 'canales', statusDot: 'green', statusText: 'Activo', gridColumn: '3 / 4', gridRow: '2 / 4' },
