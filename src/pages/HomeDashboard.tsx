...
export default function HomeDashboard() {
  ...
  const mainCards: CardConfig[] = [
    ...
    { id: 'autofomento', label: 'Control de equipo', route: '/control-equipo', bgColor: '#0A1F44', gradient: "url('/icons/dashboard/bg-control-equipo.svg') center/cover no-repeat, #0A1F44", decorType: 'silk', decorColor: 'rgba(255,255,255,0.05)', iconFile: 'gps.svg', iconOpacity: 0.20, kpiValue: '', kpiLabel: '', statusDot: kpis.cajasGPS > 0 || kpis.thermosGPS > 0 ? 'green' : 'gray', statusText: `Cajas ${kpis.cajasGPS} · Thermos ${kpis.thermosGPS}`, gridColumn: '1 / 3', gridRow: '3 / 4' },
