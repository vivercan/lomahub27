...
export default function HomeDashboard() {
  ...
  const mainCards: CardConfig[] = [
    ...
    { id: 'ventas', label: 'Ventas', route: '/ventas/analytics', bgColor: '#1E1E48', gradient: 'linear-gradient(140deg, #282858 0%, #1E1E48 40%, #141435 100%)', decorType: 'silk', decorColor: 'rgba(255,255,255,0.10)', iconFile: 'ingresos.svg', iconOpacity: 0.24, kpiValue: '', kpiLabel: '', statusDot: 'green', statusText: 'Analytics · Programa Semanal · Funnel', gridColumn: '2 / 3', gridRow: '2 / 3' },
