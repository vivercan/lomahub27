...
const si = {
  ...
  chiefOfStaff: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M12 2a4 4 0 0 1 4 4c0 2.2-1.8 4-4 4s-4-1.8-4-4a4 4 0 0 1 4-4z"/><path d="M9 14h6l1 8H8l1-8z"/><line x1="12" y1="10" x2="12" y2="14"/></svg>,
...
const modules: ModuleConfig[] = [
  ...
  },
  {
    ...
    submodulos: [
      ...
      { name: 'AI Chief of Staff', route: '/comunicaciones/chief-of-staff', icon: si.chiefOfStaff, desc: 'Tu asistente ejecutivo AI' },
    ]
  },
  {
