...
export default function HomeDashboard() {
  ...
  const mainCards: CardConfig[] = [
    ...
    { id: 'autofomento', label: 'Control de equipo', route: '/control-equipo', bgColor: '#0B2E6E', gradient: 'linear-gradient(152deg, #0F3D8A 0%, #0A2D6B 40%, #051A42 100%)', decorType: 'silk', decorColor: 'rgba(255,255,255,0.07)', iconFile: 'gps.svg', iconOpacity: 0.24, kpiValue: '', kpiLabel: '', statusDot: kpis.cajasGPS > 0 || kpis.thermosGPS > 0 ? 'green' : 'gray', statusText: `Cajas ${kpis.cajasGPS} · Thermos ${kpis.thermosGPS}`, gridColumn: '1 / 3', gridRow: '3 / 4' },
    { id: 'config', label: 'Configuración', route: '/admin/configuracion', bgColor: '#060C16', gradient: 'linear-gradient(144deg, #0A1220 0%, #060C16 40%, #152E55 100%)', decorType: 'silk', decorColor: 'rgba(255,255,255,0.07)', iconFile: 'configuracion.svg', iconOpacity: 0.24, kpiValue: '', kpiLabel: 'admin', statusDot: 'gray', statusText: 'Sistema', gridColumn: '4 / 5', gridRow: '3 / 4' },
  ]
