...
const DASH = {
  ...
  // Card gradients
  cardGradient: 'linear-gradient(180deg, rgba(54,54,67,1) 0%, rgba(42,42,54,1) 50%, rgba(33,33,43,1) 100%)',
  cardGradientWar: 'linear-gradient(180deg, rgba(56,50,56,1) 0%, rgba(42,38,48,1) 50%, rgba(31,30,40,1) 100%)',
  // Card styles
  cardRadius: '20px',
  ...
  cardShadowInset: 'inset 0 1px 0 rgba(200,210,225,0.06), inset 0 -1px 0 rgba(0,0,0,0.14)',
  cardHoverShadow: '0 14px 32px rgba(0,0,0,0.35), 0 4px 10px rgba(0,0,0,0.30)',
  // KPI
  kpiFontSize: '30px',
  kpiFontWeight: 800,
  ...
  dotSize: '3px',
  // Accent line
  accentGradient: 'linear-gradient(90deg, rgba(194,120,3,0.3) 0%, rgba(59,108,231,0.2) 50%, transparent 100%)',
  accentGradientHigh: 'linear-gradient(90deg, rgba(194,120,3,0.5) 0%, rgba(59,108,231,0.35) 50%, transparent 100%)',
} as const
...
export default function HomeDashboard() {
  ...
  // ─── MODULE DEFINITIONS (V28 — 9 módulos) ───────────
  const modules: ModuleConfig[] = [
    ...
    },
    {
      id: 'operaciones',
      label: 'Operaciones',
      icon: <Truck size={DASH.iconSizeBoosted} strokeWidth={DASH.iconStrokeBoosted} />,
      priority: 'HIGH',
  ...
  // ─── CARD STYLE BUILDER ──────────────────────────────
  const getCardStyle = (mod: ModuleConfig, isHovered: boolean): React.CSSProperties => {
    ...
    return {
      ...
      background: mod.id === 'comercial' ? DASH.cardGradientWar : DASH.cardGradient,
      ...
      transform: isHovered && !isFase2 ? 'translateY(-2px)' : 'translateY(0)',
      // Borders biselados
  ...
  return (
    ...
    >
      ...
      <div style={{
        height: '2px',
        background: 'linear-gradient(90deg, #C27803 0%, rgba(194,120,3,0.3) 60%, transparent 100%)',
      }} />
            ...
            <div key={mod.id} style={{ position: 'relative' }}>
              ...
              >
                ...
                <div style={{
                  ...
                  right: 0,
                  height: '2px',
                  background: mod.priority === 'HIGH' ? DASH.accentGradientHigh : DASH.accentGradient,
                ...
                <div style={{
                  ...
                  filter: hoveredCard === mod.id ? 'brightness(1.18)' : 'brightness(1)',
                }}>
                  {mod.icon}
                </div>
                ...
                <div style={{
                  ...
                  color: hoveredCard === mod.id
                    ? DASH.kpiColorHover
                    : (mod.priority === 'HIGH' ? DASH.kpiColorHigh : DASH.kpiColorMid),
                  lineHeight: 1.1,
                ...
                <div style={{
                  ...
                  color: hoveredCard === mod.id ? DASH.subColorHover : DASH.subColor,
                  letterSpacing: '0.3px',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '5px',
                  ...
                  {mod.statusDot && (
                    <span style={{
                      ...
                      height: DASH.dotSize,
                      borderRadius: '50%',
                      backgroundColor: DOT_COLORS[mod.statusDot] || DOT_COLORS.gray,
